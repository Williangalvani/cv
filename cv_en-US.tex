...
\descript{(Python + Raspberry Pi + Gstreamer + Asterisk + JS + HTML + CSS)}
\location{March 2016 – Now}
\vspace{\topsep}
\begin{tightitemize}
 \item Development of auxiliary drone systems for long-range High definition video and audio transmission.
...
\section{Linkedin}
\faGlobe \href[pdfnewwindow=true]{https://www.linkedin.com/in/willian-galvani-38417072}{Linkedin.com/in/willian-galvani-38417072}
