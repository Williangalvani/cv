...
\item A model was built on V-REP for testing the kinematics and gaits.
\item Optmizator and geometry for the inverse kinematics.
\end{tightitemize}
...
\runsubsection{HkSearcher}
\href[pdfnewwindow=true]{https://github.com/Williangalvani/hkSearcher}{\faGithub}
\descript{(Python + Django + JQuery)}
\begin{tightitemize}
 \item Scrapper and search engine for motors and batteries on HobbyKing  \end{tightitemize}
