...
\runsubsection{Halio (WIP)}\href[pdfnewwindow=true]{https://github.com/IBEXcps}{\faGithub}
\descript{(C++, Django, HTML, CSS, JQery)}
\vspace{\topsep}

\begin{tightitemize}
\item An IOT smart outlet able to control and analyze power consumption with modern data analysis algorithms.
\item The project was based on expressif's architecture and a multithreaded software system using modern C++ techniques.
To perform the control and visualization of the algorithms a front/backend was developed with Django, Rest Framework, HTML and JQuery.
\end{tightitemize}
